...
layerstack = {
    ...
    (802, 727): (0, 0.1, 'wgkoam'),
    (803, 727): (0, 0.1, 'metkoam'),

    # PDK Component Layers
    (804, 727): (0, 0.1, 'pdk_abstractam'),
    (725, 727): (0, 0.1, 'pdk_metal'),
    (709, 727): (0, 0.1, 'pdk_ports')
